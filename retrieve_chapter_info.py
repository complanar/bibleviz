...
for chapter in root.iter('{http://www.bibletechnologies.net/2003/OSIS/namespace}chapter'):
    verses = 0
    for verse in chapter.findall('{http://www.bibletechnologies.net/2003/OSIS/namespace}verse'):
        verses += 1
